<cfoutput>
	...
	<cfif arrayLen(rc.arrArchiveSearch) gt 0>
		<cfloop array="#rc.arrArchiveSearch#" index="model">
			<cfif listFind(application.stcThisSite.stcSetTypes.strPhotos,model.strGalleryType)>
				<div class="col-md-3 col-xs-6 item-row">
					...
					<div class="personalContent">
						<p><a href="/index.cfm/models/#model.strModelLink#" class="text-pink text-bold">#model.strModelName#</a></p>
						<div>
							...
							<span class="text-pink mobile-block Myriad-Pro-Condensed-25">
								<span class="desktop">&nbsp;&nbsp;|&nbsp;&nbsp;</span> <i class="fa fa-camera"></i> #model.intImages#
							</span>
						</div>
					</div>
				</div>
			<cfelseif listFind(application.stcThisSite.stcSetTypes.strVideos,model.strGalleryType)>
				<div class="col-md-3 col-xs-6 item-row">
					...
					<div class="personalContent">
						<p><a href="/index.cfm/models/#model.strModelLink#" class="text-blue text-bold">#model.strModelName#</a></p>
						<div>
							<span class="mobile-block mobi-margin-bottom-10 Myriad-Pro-Condensed-25">#DateFormat(model.datRelease, "dd.mm.yyyy")#</span> 
							<span class="text-blue mobile-block Myriad-Pro-Condensed-25">
								<span class="desktop">&nbsp;&nbsp;|&nbsp;&nbsp;</span> <i class="fa fa-film"></i> #model.strVideoTime#
							</span>
						</div>
					</div>
				</div>
	...
	<cfelse>
		<div class="col-md-12 col-sm-12 col-xs-12 rs-text">Currently there are no sets matching the selected filter</div>
	</cfif>
</cfoutput>