	...
	<div class="row marginBottom-10">
		<div class="col-md-12 col-sm-12 col-x-12">
			...
			<p class="text-des-section marginBottom-10 text-center">
				Thank you for comfirming your email address.<br>
				You are now subscribed to our free daily email, and will receive a sample image from each set released across all of our sites. Currently we are updating OnlyAllSites with around 8-10 new sets per day.
			</p>
		</div>
	</div>
