<cfoutput>
	...
	<div class="row marginBottom-10">
		<div class="col-md-12 col-sm-12 col-x-12">
			<h1 class="title-Section text-camel">Only All Sites Newsletter</h1>
			<p class="text-des-section marginBottom-10 text-center text-bold">
				Thank you
			</p>
			<p class="text-des-section marginBottom-10 text-center">
				Your email address has been added to the database.<br>
				You will receive an email asking you to confirm your subsciption.<br>
				Please click on the link in the email to active your subsciption.
			</p>
		</div>
	</div>
